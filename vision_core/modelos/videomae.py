...
from vision_core.paths import VIDEOMAE_DIR, YOLO_TRACKING, _str
...
class VideoMAEDetector(DetectorBase):
    ...
    def cargar(self):
        ...
        # Si YOLO_TRACKING no existe localmente, ultralytics lo descarga solo
        self.yolo = YOLO(_str(YOLO_TRACKING))
        self.processor = VideoMAEImageProcessor.from_pretrained("MCG-NJU/videomae-base")
        self.model = VideoMAEForVideoClassification.from_pretrained(_str(self.ruta_pesos))
