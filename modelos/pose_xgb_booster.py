...
from modelos.pose_base import PoseDetectorBase
...
class PoseXGBBoosterDetector(PoseDetectorBase):
    ...
    ruta_yolo_pose = "pesos/pose_xgb_booster/pose_booster.pt"

    def __init__(self, ruta_clasificador: str = "pesos/pose_xgb_booster/model_weights.json"):
        super().__init__(self.nombre)
        self.ruta_clasificador = ruta_clasificador

    def cargar_clasificador(self):
        self.clasificador = xgb.Booster()
        self.clasificador.load_model(self.ruta_clasificador)
